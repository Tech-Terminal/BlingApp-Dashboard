  ...
  >
    ...
    <div class="menu-item px-3 my-0">
      <router-link
        ...
        @click="setMode('light')"
      >
        <span class="menu-title me-auto">{{ $translate("Light") }}</span>
    ...
    <div class="menu-item px-3 my-0">
      <router-link
        ...
        @click="setMode('dark')"
      >
        <span class="menu-title me-auto">{{ $translate("Dark") }}</span>
        <span class="menu-icon" data-kt-element="icon">
    ...
    <div class="menu-item px-3 my-0">
      ...
      >
        <span class="menu-title me-auto">{{ $translate("System") }}</span>
        <span class="menu-icon" data-kt-element="icon">
