...
export default defineComponent({
  ...
  setup() {
    ...
    onBeforeMount(() => {
      ...
      /**
       *  Sets a mode from configuration, but user's saved preference takes priority
       */
      const savedTheme = localStorage.getItem("kt_theme_mode_value") as
        | "light"
        | "dark"
        | "system"
        | null;
      themeStore.setThemeMode(savedTheme || themeConfigValue.value);
    });
    ...
    onMounted(() => {
      nextTick(() => {
        ...
        // Initialize language and HTML layout direction globally
